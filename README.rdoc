...
Rdpl is a simple gem that abstracts *some* of the DPL (Datamax Programming Language)(TM) concepts. It's main purpose is to simplify the creation of labels to be printed using the Datamax(TM) series of printers.
